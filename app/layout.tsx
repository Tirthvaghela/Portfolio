...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://tirthvaghela.in/og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://tirthvaghela.in/og-image.png"],
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        <meta property="og:image" content="https://tirthvaghela.in/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta name="twitter:image" content="https://tirthvaghela.in/og-image.png" />
