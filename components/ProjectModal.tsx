          ...
          >
            ...
            <div style={{ padding: "clamp(20px, 5vw, 40px)" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                    <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "1.5px", textTransform: "uppercase", color: project.color, background: `${project.color}15`, padding: "3px 10px", borderRadius: 2 }}>
                      {project.category}
                    </span>
                  </div>
                  <h2 style={{ fontSize: 28, fontWeight: 900, color: "#111", letterSpacing: "-1px", lineHeight: 1, marginBottom: 4 }}>
                    {project.title}
                  </h2>
                ...
                <button
                  onClick={onClose}
                  style={{ background: "#f5f5f5", border: "none", borderRadius: "50%", width: 36, height: 36, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", flexShrink: 0, transition: "background 0.2s" }}
              ...
              <div style={{ marginBottom: 28 }}>
                <h3 style={{ fontSize: 12, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", color: "#bbb", marginBottom: 16 }}>
                  Key Features
                </h3>
                <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                  {project.points.map((pt, i) => (
                    <li key={i} style={{ display: "flex", gap: 12, fontSize: 14, color: "#444", lineHeight: 1.7 }}>
              ...
              <div style={{ marginBottom: 32 }}>
                <h3 style={{ fontSize: 12, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", color: "#bbb", marginBottom: 12 }}>
                  Tech Stack
                </h3>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                  {project.tech.map((t) => (
                    <span key={t} style={{ fontSize: 13, color: "#333", background: "#f5f5f5", padding: "6px 14px", borderRadius: 3, border: "1px solid #e8e8e8", fontWeight: 500 }}>
                      {t}
                    </span>
                  ))}
                </div>
