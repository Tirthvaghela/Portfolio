  ...
  return (
    <section id="about" className="hero-section">
      ...
      <div className="hero-grid">
        ...
        <div className="hero-left">
          <h1 style={{ fontWeight: 900, color: "#111", marginBottom: 8, lineHeight: 1 }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 2 }}>
              <span style={{ fontSize: "clamp(28px, 6vw, 80px)", fontStyle: "italic", letterSpacing: "-2px", fontWeight: 900, color: "#111" }}>My</span>
              <span style={{ fontSize: "clamp(12px, 1.4vw, 20px)", fontStyle: "italic", fontWeight: 500, color: "#999", letterSpacing: "0.5px" }}>Name is</span>
            </div>
            <div style={{ fontSize: "clamp(52px, 10vw, 130px)", letterSpacing: "-5px", lineHeight: 0.88, fontWeight: 900, WebkitTextStroke: "2px #111", color: "transparent" }}>
              Tirth
            </div>
            <div stylex, 10vw, 130px)", letterSpacing: "-5px", lineHeight: 0.88, fontWeight: 900, WebkitTextStroke: "2px #111", color: "transparent", marginBottom: 20 }}>
              Vaghela
            </div>
            <div style={{ fontSize: "clamp(12px, 1.4vw, 20px)", fontWeight: 500, color: "#999", letterSpacing: "1px", textTransform: "uppercase", marginBottom: 4 }}>
              and I am a
            </div>
          </h1>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {[
              { icon: <Github size={17} />, href: "https://github.com/Tirthvaghela/thius", label: "GitHub" },
              { icon: <Linkedin size={17} />, hreinkedin.com/in/tirthvaghela/", label: "LinkedIn" },
              { icon: <Mail size={17} />, href: "mailto:vaghelatirth719@gmail.com", label: "Email" },
            ].map(({ icon, href, label }) => (
        ...
        <div className="hero-right">
          <div style={{ position: "relative", width: "100%", maxWidth: 300 }}>
            ...
            <div style={{
              ...
              background: "#eef2ff",
              displenter", justifyContent: "center", padding: 24,
            }}>
              <img src="/avatar.svg" alt="Developer illustration" style={{ width: "100%", height: "100%", objectFit: "contain", display: "block" }} />
            </div>
            <div style={{
          ...
          <div style={{ display: "flex", gap: 24, marginTop: 24 }}>
            {[{ num: "8", label: "Projects" }, { num: "5", label: "Tech Stacks" }, { num: "1", label: "Internship" }].map(({ num, label }) => (
              <div key={label} style={{ textAlign: "center" }}>
                <div stylfontSize: 28, fontWeight: 900, color: "#111", letterSpacing: "-1px", lineHeight: 1 }}>
      ...
      <style>{`
        ...
        .hero-section {
          min-height: 100vh;
          background: linear 60%, #f8f8f6 100%);
          position: relative;
          overflow: hidden;
          padding-top: 72px;
        }
        .hero-dots {
          ...
          background-image: radial-gradient(circle, #2563eb18 1px, transparent 1px);
          background-size: 32px 32px;
          mask-image: radial-gradient(ellipse 80% 80% at 50% 50%, black 40%, transparent 100%);
          -webkit-, transparent 100%);
        }
        .hero-grid {
        ...
        .hero-right {
          ...
          gap: 0; padding-left: 2%;
        }
        .hero-typewriter {
          font-size: clamp(22px, 4.5vw, 64px);
          font-weight: 600; letter-spacing: -1px; color: #2563eb;
          line-height: 1; margin-bottom: 24px; min-height: 1.1em;
          overflow: hidden; white-space: nowrap;
        }
        .btn-primary {
          background: #111; color: #fff; padding: 13px 28px;
          border-radius: 3px; font-weight: 700; font-size: 14px;
          border: 2px solid #111; cursor: pointer; letter-spacing: 0.4px;
          transition: all 0.2s;
        }
        .btn-primary:hover { background: #2563eb; border-color: #2563eb; }
        .btn-outline {
          background: transparent; color: #111; padding: 13px 28px;
          border-radius: 3px; font-weight: 700; font-size: 14px;
          border: 2px solid #111; cursor: pointer; letter-spacing: 0.4px;
          transition: all 0.2s;
        }
        ...
        .social-icon {
          ...
          justify-content: center; color: #666; text-decoration: none;
          transition: all 0.2s;
        }
        .social-icon:hover { border-color: #2563eb; color: #2563eb; }
