  ...
  return (
    <section id="experience" style={{ background: "var(--bg-alt)", padding: "var(--space-2xl) 5%", borderBottom: "var(--bw) solid var(--text)" }}>
      ...
      <style>{`
        ...
        .exp-label {
          display: flex; align-items: center; gap: 8px; font-family: var(--font-mono-face); font-size: 12px; font-weight: 800;
        ...
        .exp-index { font-family: var(--font-mono-face); font-size: clamp(40px, 4.6vw, 64px); font-weight: 500; line-height: 0.8; color: var(--text); flex-shrink: 0; }
        ...
        .exp-period { font-family: var(--font-mono-face); font-size: 12px; color: var(--text-muted); border: 1.5px solid var(--text); padding: 3px 10px; white-space: nowrap; }
        ...
        .exp-quote footer { position: relative; z-index: 1; margin-top: 10px; font-family: var(--font-mono-face); font-size: 10px; font-weight: 400; color: var(--bg-alt); letter-spacing: 0.03em; }
        .exp-links { display: flex; gap: 18px; margin-top: var(--space-md); }
        .exp-links a { font-family: var(--font-mono-face); font-size: 12px; color: var(--text); text-decoration: none; border-bottom: 2px solid var(--accent); font-weight: 600; display: inline-flex; align-items: center; gap: 4px; }
        .ext-arrow { display: inline-block; vertical-align: -2px; }
        .exp-status { display: inline-block; margin-top: 8px; font-family: var(--font-mono-face); font-size: 11px; font-weight: 700; letter-spacing: 0.05em; color: var(--accent); border: 1.5px solid var(--accent); padding: 3px 10px; }
        ...
        .exp-badge { font-family: var(--font-mono-face); font-size: 11px; font-weight: 700; color: var(--text); border: 1.5px solid var(--text); padding: 3px 10px; }
        ...
        .exp-course a { font-family: var(--font-mono-face); font-size: 11px; color: var(--text-muted); margin-top: 4px; display: inline-flex; align-items: center; gap: 4px; text-decoration: none; border-bottom: 1.5px solid var(--accent); }
